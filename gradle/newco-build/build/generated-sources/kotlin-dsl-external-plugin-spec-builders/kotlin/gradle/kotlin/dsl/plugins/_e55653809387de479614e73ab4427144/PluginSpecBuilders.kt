...
package gradle.kotlin.dsl.plugins._e55653809387de479614e73ab4427144
...
/**
 * The `build` plugin group.
 */
@org.gradle.api.Generated
internal
class `BuildPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `build`.
 */
internal
val `PluginDependenciesSpec`.`build`: `BuildPluginGroup`
    get() = `BuildPluginGroup`(this)


/**
 * The `build.buf` plugin implemented by [build.buf.gradle.BufPlugin].
 */
internal
val `BuildPluginGroup`.`buf`: PluginDependencySpec
    get() = plugins.id("build.buf")
...
/**
 * The `com.bmuschko` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComBmuschkoPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.bmuschko`.
 */
internal
val `ComPluginGroup`.`bmuschko`: `ComBmuschkoPluginGroup`
    get() = `ComBmuschkoPluginGroup`(plugins)


/**
 * The `com.bmuschko.docker-java-application` plugin implemented by [com.bmuschko.gradle.docker.DockerJavaApplicationPlugin].
 */
internal
val `ComBmuschkoPluginGroup`.`docker-java-application`: PluginDependencySpec
    get() = plugins.id("com.bmuschko.docker-java-application")


/**
 * The `com.bmuschko.docker-remote-api` plugin implemented by [com.bmuschko.gradle.docker.DockerRemoteApiPlugin].
 */
internal
val `ComBmuschkoPluginGroup`.`docker-remote-api`: PluginDependencySpec
    get() = plugins.id("com.bmuschko.docker-remote-api")


/**
 * The `com.bmuschko.docker-spring-boot-application` plugin implemented by [com.bmuschko.gradle.docker.DockerSpringBootApplicationPlugin].
 */
internal
val `ComBmuschkoPluginGroup`.`docker-spring-boot-application`: PluginDependencySpec
    get() = plugins.id("com.bmuschko.docker-spring-boot-application")


/**
 * The `com.buildkite` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComBuildkitePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.buildkite`.
 */
internal
val `ComPluginGroup`.`buildkite`: `ComBuildkitePluginGroup`
    get() = `ComBuildkitePluginGroup`(plugins)


/**
 * The `com.buildkite.test-collector-android` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComBuildkiteTest-collector-androidPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.buildkite.test-collector-android`.
 */
internal
val `ComBuildkitePluginGroup`.`test-collector-android`: `ComBuildkiteTest-collector-androidPluginGroup`
    get() = `ComBuildkiteTest-collector-androidPluginGroup`(plugins)


/**
 * The `com.buildkite.test-collector-android.unit-test-collector-plugin` plugin implemented by [com.buildkite.test.collector.android.UnitTestCollectorPlugin].
 */
internal
val `ComBuildkiteTest-collector-androidPluginGroup`.`unit-test-collector-plugin`: PluginDependencySpec
    get() = plugins.id("com.buildkite.test-collector-android.unit-test-collector-plugin")
...
/**
 * The `com.github.gmazzo` plugin group.
 */
@org.gradle.api.Generated
internal
class `ComGithubGmazzoPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `com.github.gmazzo`.
 */
internal
val `ComGithubPluginGroup`.`gmazzo`: `ComGithubGmazzoPluginGroup`
    get() = `ComGithubGmazzoPluginGroup`(plugins)


/**
 * The `com.github.gmazzo.buildconfig` plugin implemented by [com.github.gmazzo.buildconfig.BuildConfigPlugin].
 */
internal
val `ComGithubGmazzoPluginGroup`.`buildconfig`: PluginDependencySpec
    get() = plugins.id("com.github.gmazzo.buildconfig")
...
/**
 * The `io.micronaut.aot` plugin implemented by [io.micronaut.gradle.aot.MicronautAotPlugin].
 */
internal
val `IoMicronautPluginGroup`.`aot`: PluginDependencySpec
    get() = plugins.id("io.micronaut.aot")


/**
 * The `io.micronaut.application` plugin implemented by [io.micronaut.gradle.MicronautApplicationPlugin].
 */
internal
val `IoMicronautPluginGroup`.`application`: PluginDependencySpec
    get() = plugins.id("io.micronaut.application")


/**
 * The `io.micronaut.component` plugin implemented by [io.micronaut.gradle.MicronautComponentPlugin].
 */
internal
val `IoMicronautPluginGroup`.`component`: PluginDependencySpec
    get() = plugins.id("io.micronaut.component")


/**
 * The `io.micronaut.docker` plugin implemented by [io.micronaut.gradle.docker.MicronautDockerPlugin].
 */
internal
val `IoMicronautPluginGroup`.`docker`: PluginDependencySpec
    get() = plugins.id("io.micronaut.docker")


/**
 * The `io.micronaut.graalvm` plugin implemented by [io.micronaut.gradle.graalvm.MicronautGraalPlugin].
 */
internal
val `IoMicronautPluginGroup`.`graalvm`: PluginDependencySpec
    get() = plugins.id("io.micronaut.graalvm")


/**
 * The `io.micronaut.library` plugin implemented by [io.micronaut.gradle.MicronautLibraryPlugin].
 */
internal
val `IoMicronautPluginGroup`.`library`: PluginDependencySpec
    get() = plugins.id("io.micronaut.library")


/**
 * The `io.micronaut.minimal` plugin group.
 */
@org.gradle.api.Generated
internal
class `IoMicronautMinimalPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `io.micronaut.minimal`.
 */
internal
val `IoMicronautPluginGroup`.`minimal`: `IoMicronautMinimalPluginGroup`
    get() = `IoMicronautMinimalPluginGroup`(plugins)


/**
 * The `io.micronaut.minimal.application` plugin implemented by [io.micronaut.gradle.MicronautMinimalApplicationPlugin].
 */
internal
val `IoMicronautMinimalPluginGroup`.`application`: PluginDependencySpec
    get() = plugins.id("io.micronaut.minimal.application")


/**
 * The `io.micronaut.minimal.library` plugin implemented by [io.micronaut.gradle.MicronautMinimalLibraryPlugin].
 */
internal
val `IoMicronautMinimalPluginGroup`.`library`: PluginDependencySpec
    get() = plugins.id("io.micronaut.minimal.library")


/**
 * The `io.micronaut.test-resources` plugin implemented by [io.micronaut.gradle.testresources.MicronautTestResourcesPlugin].
 */
internal
val `IoMicronautPluginGroup`.`test-resources`: PluginDependencySpec
    get() = plugins.id("io.micronaut.test-resources")


/**
 * The `io.micronaut.test-resources-consumer` plugin implemented by [io.micronaut.gradle.testresources.MicronautTestResourcesConsumerPlugin].
 */
internal
val `IoMicronautPluginGroup`.`test-resources-consumer`: PluginDependencySpec
    get() = plugins.id("io.micronaut.test-resources-consumer")
...
/**
 * The `org.pkl-lang` plugin implemented by [org.pkl.gradle.PklPlugin].
 */
internal
val `OrgPluginGroup`.`pkl-lang`: PluginDependencySpec
    get() = plugins.id("org.pkl-lang")
